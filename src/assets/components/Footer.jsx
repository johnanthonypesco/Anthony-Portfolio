...
export default function Footer(){
    return(
        <footer className="py-10 flex flex-col justify-center items-center lg:mt-0">
            ...
            <p className="mt-5 font-regular flex items-center text-center gap-2">Copyright <span className="text-[#f12711] font-bold text-[20px]">&copy;</span> John Anthony Pesco. All Rights Reserved</p>
        </footer>
    );  
}